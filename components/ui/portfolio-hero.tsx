    ...
    return (
        ...
        >
            ...
            <main className="relative min-h-screen flex flex-col">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4 pt-10">
                    <div className="relative text-center">
                        <div>
                            <BlurText
                                ...
                                animateBy="letters"
                                direction="top"
                                className="font-bold text-[75px] sm:text-[100px] md:text-[140px] lg:text-[180px] xl:text-[210px] leading-[0.8] tracking-tighter uppercase justify-center whitespace-nowrap"
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                            <div className="w-[80px] h-[130px] sm:w-[100px] sm:h-[160px] md:w-[130px] md:h-[200px] lg:w-[150px] lg:h-[240px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer border-2 border-background/20">
                                {/* NOTE: Define your custom image path here. 
                    Place your image file in the 'public' folder and update the src below. */}
                                <img
                                    src="/profile.jpg"
                                    alt="Aanish Bangre"
                                    onError={(e) => {
                                        // Fallback to stock unsplash image if local file is missing
